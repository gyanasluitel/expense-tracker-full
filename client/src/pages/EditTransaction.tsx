            ...
            <Box component="form" onSubmit={handleSubmit(onSubmit)} display="flex" flexDirection="column" gap={2}>
                    ...
                    render={({ field }) => (
                        <FormControl fullWidth error={!!errors.type}>
                            ...
                            <Select
                                ...
                                onChange={(e) => {
                                    field.onChange(e);
                                    reset((prev) => ({ ...prev, type: e.target.value as "Income" | "Expense", category: "" }));
                                }}
                            >
                ...
                <Box>
                    ...
                    <Button variant="outlined" onClick={() => fileInputRef.current?.click()}>
                        {selectedFile 
                            ? selectedFile.name 
                            : (currentTransaction?.fileUrl && !isExistingFileCleared ? "Update Receipt" : "Add Receipt (optional)")}
                    </Button>
                    {currentTransaction?.fileUrl && !isExistingFileCleared && !selectedFile && (
